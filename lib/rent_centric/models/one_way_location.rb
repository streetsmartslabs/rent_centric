...
module RentCentric
  class OneWayLocation
    ...
    def self.swagger_types
      {
        ...
        :'drop_off_locations' => :'Array<LocationDTO>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DropOffLocations')
        if (value = attributes[:'DropOffLocations']).is_a?(Array)
          self.drop_off_locations = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          drop_off_locations == o.drop_off_locations
    end
    ...
    def hash
      [pick_up_location, drop_off_locations].hash
    end
