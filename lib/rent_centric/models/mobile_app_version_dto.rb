...
module RentCentric
  class MobileAppVersionDTO
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MobileAppName')
        self.mobile_app_name = attributes[:'MobileAppName']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          mobile_app_name == o.mobile_app_name
    end
