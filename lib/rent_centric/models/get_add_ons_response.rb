...
module RentCentric
  class GetAddOnsResponse
    attr_accessor :insurances

    attr_accessor :misc_charges
    ...
    def self.swagger_types
      {
        ...
        :'misc_charges' => :'Array<MiscChargeDTO>',
        :'taxes' => :'Array<TaxDTO>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MiscCharges')
        if (value = attributes[:'MiscCharges']).is_a?(Array)
          self.misc_charges = value
        end
      end
    ...
    def hash
      [insurances, misc_charges, taxes].hash
    end
