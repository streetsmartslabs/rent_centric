...
module RentCentric
  class ResponseListGetLocationsByAvailableVehiclesDTO
    ...
    def self.swagger_types
      {
        :'result' => :'Array<GetLocationsByAvailableVehiclesDTO>',
        :'description' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ExceptionMessage')
        self.exception_message = attributes[:'ExceptionMessage']
      end
    ...
    def hash
      [result, description, exception_message, state].hash
    end
