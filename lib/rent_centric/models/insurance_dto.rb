...
module RentCentric
  class InsuranceDTO
    ...
    attr_accessor :insurance_name

    attr_accessor :insurance_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'InsuranceId')
        self.insurance_id = attributes[:'InsuranceId']
      end

      if attributes.has_key?(:'InsuranceName')
        self.insurance_name = attributes[:'InsuranceName']
      end

      if attributes.has_key?(:'InsuranceCode')
        self.insurance_code = attributes[:'InsuranceCode']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          insurance_name == o.insurance_name &&
          insurance_code == o.insurance_code &&
    ...
    def hash
      [insurance_id, insurance_name, insurance_code, hourly_rate, daily_rate, is_default, is_default_on_self_service, rate, calculation_type, memo, is_mandatory, option_group].hash
    end
