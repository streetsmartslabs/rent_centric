...
module RentCentric
  class GetActiveReservationResponse
    ...
    def self.swagger_types
      {
        :'reservation_list' => :'Array<ReservationDto>',
        :'rental_id' => :'Integer',
        :'ra_number' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ReservationList')
        if (value = attributes[:'ReservationList']).is_a?(Array)
    ...
    def hash
      [reservation_list, rental_id, ra_number].hash
    end
