...
module RentCentric
  class GetVehicleCalendarResponse
    attr_accessor :vehicle_calendar

    attr_accessor :total_amount

    attr_accessor :km_included
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'KmIncluded')
        self.km_included = attributes[:'KmIncluded']
      end
    end
    ...
    def hash
      [vehicle_calendar, total_amount, km_included].hash
    end
