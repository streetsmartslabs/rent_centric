...
module RentCentric
  class GetReservationsRequest
    ...
    attr_accessor :is_leaving_today
    ...
    def self.attribute_map
      {
        ...
        :'is_leaving_today' => :'IsLeavingToday'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IsLeavingToday')
        self.is_leaving_today = attributes[:'IsLeavingToday']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_leaving_today == o.is_leaving_today
    end
    ...
    def hash
      [reservation_id, admin_id, location_id, customer_id, first_name, last_name, phone_number, email, res_number, make, model, pick_up_location_id, start_date_time, end_date_time, is_checked_out, is_checked_in, is_cancelled, vehicle_id, assigned_id, customer_license_number, is_leaving_today].hash
    end
