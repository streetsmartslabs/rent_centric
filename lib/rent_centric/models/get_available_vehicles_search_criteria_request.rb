...
module RentCentric
  class GetAvailableVehiclesSearchCriteriaRequest
    ...
    def hash
      [pick_up_location_id, drop_off_location_id, pick_up_date_time, drop_off_date_time, vehicle_type_id, customer_id].hash
    end
