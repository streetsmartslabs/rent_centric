...
module RentCentric
  class GetLocationsByAvailableVehiclesRequest
    attr_accessor :pick_up_location_id

    attr_accessor :drop_off_location_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DropOffLocationId')
        self.drop_off_location_id = attributes[:'DropOffLocationId']
      end
      ...
      if attributes.has_key?(:'CurrentLocation')
        self.current_location = attributes[:'CurrentLocation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          drop_off_location_id == o.drop_off_location_id &&
    ...
    def hash
      [pick_up_location_id, drop_off_location_id, pick_up_date_time, drop_off_date_time, vehicle_type_id, make, model, current_location, customer_id].hash
    end
